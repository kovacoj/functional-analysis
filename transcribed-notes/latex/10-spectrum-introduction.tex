...
\begin{warningbox}{Complex scalars matter}
The standard spectrum theory in this form is for complex Banach spaces. For real spaces one usually passes to the complexification.
\end{warningbox}
