...
\item More generally, a metric linear space built from a separating sequence of seminorms and complete for that metric is called a \textbf{Fr\'echet space}. In the course this becomes Theorem~\ref{thm:frechet-metric} later.
\end{itemize}
\end{defbox}
